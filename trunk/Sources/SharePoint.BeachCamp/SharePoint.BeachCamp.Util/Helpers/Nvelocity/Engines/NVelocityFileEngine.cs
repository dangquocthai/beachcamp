...
using SharePoint.BeachCamp.Util.NVelocityTemplateEngine.BaseClasses;
using SharePoint.BeachCamp.Util.NVelocityTemplateEngine.Interfaces;

namespace SharePoint.BeachCamp.Util.NVelocityTemplateEngine.Engines
{
	/// <summary>
